...
import uuid
from decimal import Decimal # Import Python's standard Decimal type
...
class Cart(models.Model):
    ...
    def get_total_price(self):
        ...
        Converts MongoDB's Decimal128 to Python's Decimal for calculation.
        """
        # FIX: Convert the price to a standard Decimal before multiplying.
        # The .to_decimal() method is provided by the Decimal128 object.
        return sum(item.product.price.to_decimal() * item.quantity for item in self.items.all())
